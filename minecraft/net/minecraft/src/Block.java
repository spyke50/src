...
public class Block
{
    ...
    public static final Block platinBlock = (new Block(174, Material.rock)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("blockPlatin").setCreativeTab(CreativeTabs.tabBlock).setTextureName("diamond_block");
    /** ID of the block. */
